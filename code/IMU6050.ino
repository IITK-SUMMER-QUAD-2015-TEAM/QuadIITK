...
{
  Serial.print((double)Gx / GYRO_DIVIDING_FACTOR); Serial.print('\t');
  Serial.print((double)Gy / GYRO_DIVIDING_FACTOR);Serial.print('\t');
  Serial.print((double)Gz / GYRO_DIVIDING_FACTOR); Serial.print('\t');
