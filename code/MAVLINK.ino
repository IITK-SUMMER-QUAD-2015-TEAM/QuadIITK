...
void sendInformation(void)
{
 ...
 /* mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_pack(MAV_SYSTEM_ID, MAV_COMPONENT_ID,&msg,sysTimeMillis,rollPID.getSetPoint(),pitchPID.getSetPoint(),yawPID.getSetPoint(),0);
  ...
  mavlink_msg_debug_pack(MAV_SYSTEM_ID, MAV_COMPONENT_ID, &msg,sysTimeMillis,1,gyroRate[XAXIS]);
  len=mavlink_msg_to_send_buffer(buf, &msg);
  Serial.write(buf, len);
  
  mavlink_msg_debug_pack(MAV_SYSTEM_ID, MAV_COMPONENT_ID, &msg,sysTimeMillis,2,rollPID.getSetPoint());
  len=mavlink_msg_to_send_buffer(buf, &msg);
  Serial.write(buf, len);
  
  mavlink_msg_debug_pack(MAV_SYSTEM_ID, MAV_COMPONENT_ID, &msg,sysTimeMillis,3,gyroRate[YAXIS]);
  len=mavlink_msg_to_send_buffer(buf, &msg);
  Serial.write(buf, len);
  
  mavlink_msg_debug_pack(MAV_SYSTEM_ID, MAV_COMPONENT_ID, &msg,sysTimeMillis,4,pitchPID.getSetPoint());
  len=mavlink_msg_to_send_buffer(buf, &msg);
  Serial.write(buf, len);
